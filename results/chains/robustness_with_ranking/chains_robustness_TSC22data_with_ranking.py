...
for count, data_name in enumerate(data_names):
    ...
    # evaluate
    recalls, precisions, f1_scores, chain_lengths = utils.get_metrics_for_experiment(max_dilation, data_name, use_case, offset, non_overlapping, target_w, m, ground_truth)
